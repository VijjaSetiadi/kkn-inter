...
@section('title', 'Edit Periode KKN')
        ...
        <div class="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
                <h2 class="text-2xl md:text-3xl font-bold text-white mb-2 flex items-center gap-3 drop-shadow-md">
                    <i class="fas fa-edit text-yellow-400 text-2xl md:text-3xl drop-shadow"></i>
                    Edit Periode KKN
                </h2>
            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-5">
                        ...
                        <div>
                            ...
                            <select name="semester" 
                                ...
                                <option value="1" {{ old('semester', $period->semester) == 1 ? 'selected' : '' }}>Semester 1</option>
                                <option value="2" {{ old('semester', $period->semester) == 2 ? 'selected' : '' }}>Semester 2</option>
                            </select>
                            @error('semester')
                                <small class="text-red-500 font-medium mt-1 block">{{ $message }}</small>
                            @enderror
